...
Look for an address starting with "192.168.137" but not ending with ".1" or ".255" - this is a new address of the Orange Pi.

Now you can connect to Orange Pi via SSH (in Armbian default username is **root** and password is **1234**.
